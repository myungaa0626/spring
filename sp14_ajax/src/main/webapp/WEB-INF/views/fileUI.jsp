...
$(document).ready(function(){
    ...
    $('#practiceform input[name=file]').MultiFile({
        max: 5, //업로드 최대 파일 갯수 (지정하지 않으면 무한대)
        accept: 'jpg|png|gif', //허용할 확장자(지정하지 않으면 모든 확장자 허용)
        maxfile: 1024, //각 파일 최대 업로드 크기 1024
        maxsize: 3024,  //전체 파일 최대 업로드 크기 3024
...
<h3> fileUI.jsp 에서 파일 1개를 컨트롤러에서 받아서 성공하면 성공 메세지, 실패하면 실패 메시지 띄우기. 
ui --> controller : ajax 사용 연습하기 </h3>


<form name="practiceform" id="practiceform" action="<%=request.getContextPath() %>/fileUpload2"
                                      method="POST" enctype="multipart/form-data">
                                                                       
	제목: <input type="text" name="title"  value=""/> <br/>
	내용 :<input type="text" name="description"  value="" /> <br/>
